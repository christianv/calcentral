...
describe "MyAcademics::Semesters" do
  ...
  it "should get properly formatted data from fake Oracle MV", :if => SakaiData.test_data? do
    ...
    oski_semesters[1][:schedule][0][:transcript_unit].should be_nil
    ...
    oski_semesters[2][:schedule][0][:transcript_unit].should == "4"
    oski_semesters[2][:schedule][1][:grade].should == "C+"
    oski_semesters[2][:schedule][1][:transcript_unit].should == "3"
